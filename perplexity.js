...
const AGENT_IDS = ["agent-1722260873"]; 
const ENDPOINT_ID = "predefined-openai-gpt4.1";
const REASONING_MODE = "grok-4-fast";
const FULFILLMENT_PROMPT = "Create a report with a summary at the top, and multiple sections and headers based on the information received";
