...
const AGENT_IDS = ["agent-1762176202"]; 
const ENDPOINT_ID = "predefined-openai-gpt4.1";
const REASONING_MODE = "flash";
const FULFILLMENT_PROMPT = "Write a summary of the findings. Include the pdf URL at the bottom of the email. Do not format as markdown. Keep plain text.";
...
const FILE_AGENTS = [
  ...
  "agent-1713961903",
  "agent-1713967141",
]; // e.g., ["plugin-1744182699", "plugin-1713958591"]
